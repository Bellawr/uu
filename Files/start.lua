...
type = 'inline',
data = {
{{text = '⌔ 𝘣𝘦𝘭𝘭𝘢 𝘴𝘰𝘳𝘶𝘤𝘦 .',url="t.me/EE92i"}},
}
}
...
{{text = '⌔ قناه التحديثات .',url="t.me/EE92i"}},
{{text = '⌔ رجوع .',data="Can"}},
}
}
...
{{text = '⌔ تغيير اسم البوت .',data="namebot"},{text =(redis:get(bot_id..":namebot") or "بيلا"),data="delnamebot"}},
...
os.execute('curl -s https://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@raw.githubusercontent.com/Vinesdevv/u/main/start.lua -o start.lua')
dofile('start.lua')  
end
if Text == "UpBot" then
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg.chat_id .. "&photo=https://t.me/EE92i&caption=".. URL.escape(Text).."&photo=0&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
if text == "الساعه" then
bot.sendText(msg.chat_id,msg.id,"*⌔︙الساعه الان : ( "..os.date("%I:%M%p").." ) .*","md",true)  
end
if text == "شسمك" or text == "سنو اسمك" then
namet = {"حجي اسمي "..(redis:get(bot_id..":namebot") or "بيلا"),"يابه اسمي "..(redis:get(bot_id..":namebot") or "بيلا"),"اني لقميل "..(redis:get(bot_id..":namebot") or "بيلا"),(redis:get(bot_id..":namebot") or "بيلا").." اني"}
bot.sendText(msg.chat_id,msg.id,"*"..namet[math.random(#namet)].."*","md",true)  
end 
if text == "بوت" or text == (redis:get(bot_id..":namebot") or "بيلا") then
...
caption=('*𝘸𝘦𝘭𝘤𝘰𝘮𝘦 𝘵𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 𝘷𝘪𝘯𝘦𝘴 .\n\n*[⌔  𝘷𝘪𝘯𝘦𝘴 𝘤𝘩𝘢𝘯𝘯𝘦𝘭 .](http://t.me/EE92i)*\n\n*[⌔  𝘪𝘯𝘧𝘰 𝘴𝘰𝘶𝘳𝘤𝘦 .](http://t.me/EE28i)*\n\n*[⌔  𝘷𝘪𝘯𝘦𝘴 𝘥𝘦𝘷𝘦𝘭𝘰𝘱𝘦𝘳 .](http://t.me/SSSSSSY)*\n\n*[⌔  𝘣𝘰𝘵 𝘷𝘪𝘯𝘦𝘴 .](http://t.me/b5Ebot)'),
reply_to_message_id=msg.id,
parse_mode="markdown",
reply_markup=markup(nil,{{{text = '⌔  𝘣𝘦𝘭𝘭𝘢 𝘴𝘰𝘳𝘶𝘤𝘦 .',url="t.me/EE92i"}}})
})
...
--else
---return bot.sendText(665877797,0,data.luatele,"md",true)  
--
end
----------------------------------------------------------------------------------------------------
end
